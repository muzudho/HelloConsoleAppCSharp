...
+-- 📁 Infrastructure
|   +-- 📁 Logging
|   |   +-- 📄 MuzLogging.cs             # （後述）ファイルを新規作成
|   +-- 📄 MuzInfrastructureHelper.cs    # （後述）ファイルを新規作成
+-- 📄 appsettings.json                  # （後述）ファイルを新規作成
```
...
📄 `HelloConsoleAppCSharp/Infrastructure/MuzInfrastructureHelper.cs`:  
