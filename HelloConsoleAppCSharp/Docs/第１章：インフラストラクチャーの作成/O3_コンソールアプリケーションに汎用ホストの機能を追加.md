...
NuGet を使って以下のパッケージを `HelloConsoleAppCSharp` と `HelloConsoleAppCSharp.Core` プロジェクトへインストールしてください。  
...
📄 `HelloConsoleAppCSharp.Core/Infrastructure/MuzInfrastructureService.cs`:  
