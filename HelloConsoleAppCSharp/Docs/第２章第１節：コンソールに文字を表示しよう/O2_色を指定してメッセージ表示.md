# 第２章第１節：コンソールに文字を表示しよう　＞　色を指定してメッセージ表示
...
|   |       +-- 📄 MuzPrintMessageWithColorCommandParser.cs  # ファイルを新規作成
...
📄 `HelloConsoleAppCSharp.Core/Infrastructure/ConsoleCustom/MuzConsoleHelper.cs`:  

```csharp
namespace HelloConsoleAppCSharp.Core.Infrastructure.ConsoleCustom;
...
📄 `HelloConsoleAppCSharp/Commands/Prints/MuzPrintMessageWithColorCommand.cs`:  
